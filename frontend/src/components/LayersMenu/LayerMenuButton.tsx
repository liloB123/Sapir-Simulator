...
const LayerMenuButton: FC<LayerMenuButtonProps> = ({ isOpen, onMenuToggle }) => {
  ...
  return (
    <button onClick={onMenuToggle} className="rounded-full fixed top-14 right-4 z-50 shadow-lg p-3 hover:bg-gray-50 transition-colors duration-200 h-15 w-15 flex items-center bg-gray-100 justify-center" 
